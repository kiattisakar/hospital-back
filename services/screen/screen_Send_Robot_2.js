...
async function screen_Send_Robot_2(req, res) {
  ...
  try {
    ...
    let query = `
       SELECT
        ...
        And dbo.prescription.ordercreatedate between '2025-04-30 08:00:00' AND '2025-04-30 23:59:00'
    ...
    // WHERE
    // dbo.ms_ward.wardstatus = 'Y'
    // And dbo.prescription.ordercreatedate between '2025-03-24 08:00:00' AND '2025-03-24 23:59:00'
    // And dbo.prescription.genorderdatetime Is NULL
    // AND dbo.prescription.fromlocationname Like '%002%'
